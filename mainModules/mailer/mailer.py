...
def mailer(recepientdict)   :
    ...
    for key in recepientdict:
        ...
        msg = Message(subject="subject",
                      ...
                      body="https://website.dev/staff/forgotpassword?recoverparams="+recepientdict[key])
        mail.send(msg)
    return "success"
...
#     "MAIL_USE_TLS": False,
#     "MAIL_USE_SSL": True,
#     "MAIL_USERNAME": 'saample@gmail.com',
...
#                       recipients=["sample.m@gmail.com"], # replace with your email for testing
